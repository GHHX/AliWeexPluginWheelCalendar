...
const servePort = process.env.serport || 12580
...
var androidOpts = {
    ...
    // app: 'http://appdownload.alicdn.com/publish/weex_playgroud/latest/weex_playgroud_10006024.apk'
};
...
module.exports = {
    ...
    getPage:function(name){
        ...
        if(browser){
            ...
            // url = 'http://' + getIpAddress()+":"+servePort+"/examples/build"+name;
        }else{
            url = 'wxpage://' + getIpAddress()+":"+servePort+"/examples/build"+name;
        }
        console.log(url)
        return url
    },
