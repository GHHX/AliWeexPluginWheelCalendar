...
public class CalendarCellView extends FrameLayout {
    ...
    private static final int[] STATE_HOLIDAY = {R.attr.tsquare_state_holiday};
    ...
    private static final int[] STATE_FUTURE = {R.attr.tsquare_state_future};
    ...
    protected int[] onCreateDrawableState(int extraSpace) {
        ...
        if (isFuture) {
            mergeDrawableStates(drawableState, STATE_FUTURE);
        }
